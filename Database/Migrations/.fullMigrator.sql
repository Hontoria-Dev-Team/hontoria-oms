...
CREATE TABLE inventory (
    ...
    maxDailyAvgConsumption MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
    lastRestockDate DATE,
    lastRestockQuantity MEDIUMINT UNSIGNED NOT NULL DEFAULT 0
);
...
CREATE TABLE inventoryRecords (
    ...
    used MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
