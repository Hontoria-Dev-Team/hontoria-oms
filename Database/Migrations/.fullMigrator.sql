...
CREATE TABLE inventory (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(50) UNIQUE NOT NULL,
    minQuantity MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
    maxAvgConsumption MEDIUMINT UNSIGNED NOT NULL DEFAULT 0
);
...
CREATE TABLE inventoryRecords (
    ...
    consumption MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
    added MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
    PRIMARY KEY (date, inventoryID),
...
CREATE TABLE salesOrder (
    ...
    priceTotal DECIMAL(10, 2) NOT NULL,
    pricePaid DECIMAL(10, 2) DEFAULT 0,
    FOREIGN KEY (orderID) REFERENCES orders(id)
);
...
CREATE TABLE variableLists (
    orderID BIGINT UNSIGNED PRIMARY KEY,
    approved BOOLEAN DEFAULT FALSE,
    FOREIGN KEY (orderID) REFERENCES orders(id)
);

CREATE TABLE variableListColumns (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    orderID BIGINT UNSIGNED NOT NULL,
    columnName VARCHAR(50) NOT NULL,
    displayOrder INT NOT NULL DEFAULT 0,
    FOREIGN KEY (orderID) REFERENCES variableLists(orderID) ON DELETE CASCADE,
    UNIQUE KEY (orderID, columnName)
);

CREATE TABLE variableListValues (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    orderID BIGINT UNSIGNED NOT NULL,
    ...
    FOREIGN KEY (orderID) REFERENCES variableLists(orderID) ON DELETE CASCADE,
    FOREIGN KEY (columnID) REFERENCES variableListColumns(id) ON DELETE CASCADE,
    INDEX (orderID, rowNumber)
);

CREATE TABLE variableListRowChecks (
    orderID BIGINT UNSIGNED NOT NULL,
    rowNumber INT UNSIGNED NOT NULL,
