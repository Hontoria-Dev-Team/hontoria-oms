    ...
    <div class="modal" id="modal">
        ...
        <div class="modal-right">
            ...
            <div class="modal-field">
                ...
                <a href="<?php echo htmlspecialchars($fbLink); ?>" target="_blank" style="color:#CC1A00;font-weight:700">Facebook Messenger</a>.
                We'll get back to you with the details!</p>
            </div>

            <div class="modal-actions">
                <a href="<?php echo htmlspecialchars($fbLink); ?>" target="_blank" class="modal-order">
