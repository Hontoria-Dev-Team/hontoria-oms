...
/**
 * FooterComponents.php
 * Location: publicWeb/public/Views/.Components/SharedComponents/FooterComponents.php
 *
 * Shared across all pages (Home, Services, About Us).
 * Styles live in: /.CSS/Shared.css
 * Scripts live in: /.JS/Shared.js
 */
class FooterComponent extends \Component {

    public function render(): string {
        // Updated default logo path to match the new .Images folder
        $logoPath = $this->get('logoPath', '/.Images/logo.jpg');
